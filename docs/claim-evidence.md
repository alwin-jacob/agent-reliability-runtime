...
| Cancellation semantics | Implemented locally | Boundary tests cover shielded record/event/state commits, probe bookkeeping, active-phase cancelled persistence, terminal assembly/writing, and committed success preserved while caller cancellation is re-raised | Process termination recovery | Stage 1 |
